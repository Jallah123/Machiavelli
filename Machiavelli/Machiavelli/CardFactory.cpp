...
unique_ptr<BuildingCard> CardFactory::createBuildingCard(string _name, ColorEnum _color, int _cost)
{
	return unique_ptr<BuildingCard>(new BuildingCard(_name, _color, _cost));
}